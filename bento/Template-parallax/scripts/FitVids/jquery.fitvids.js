...
* Modified by Mercy Interactive to accommodate background fill video.
  ...
  $.fn.fitVids = function( options ) {
    ...
    return this.each(function(){
      ...
      $allVideos.each(function(count){
        ...
        if($this.parents('.bgvid').length > 0) {
          $this.wrap('<div class="fluid-width-video-wrapper bgvid"></div>').parent('.fluid-width-video-wrapper .bgvid').attr('style','width:'+(aspectRatio * 100)+'%');
          video_filler($this.attr('id'));
          $this.children('.bgvid').css('width', (aspectRatio * 100)+'%');
